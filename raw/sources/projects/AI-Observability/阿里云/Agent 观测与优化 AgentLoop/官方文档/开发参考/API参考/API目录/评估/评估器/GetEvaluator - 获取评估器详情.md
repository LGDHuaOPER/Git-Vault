---
title: "GetEvaluator - 获取评估器详情"
source: "https://help.aliyun.com/zh/document_detail/3045681.html?spm=a2c4g.11186623.help-menu-3033820.d_6_1_3_5_1_1.3a5f6283H1fndv"
author:
  - "阿里云计算"
published:
created: 2026-07-23
...
tags:
  ...
  - "官方文档"
"word-count": "500"
更新时间: "2026-07-08 12:10:46"
---
获取评估器详情。

## 调试

[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/AgentLoop/2026-05-20/GetEvaluator)[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.alibabacloud.com/api/AgentLoop/2026-05-20/GetEvaluator)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) 调试](https://api.aliyun.com/api/AgentLoop/2026-05-20/GetEvaluator)
...
```
GET /api/v1/evaluators/{agentSpace}/{name} HTTP/1.1
```
...
| **名称** | **类型** | **必填** | **描述** | **示例值** |
| --- | --- | --- | --- | --- |
| version | string | 否   | 目标版本号。不传则使用最新版本。 | 1.0.0 |
...
| evaluator | object | 评估器详情。 | {"name":"trace\\_task\\_completion","type":"AGENT","currentVersion":"1.0.0"} |
| agentSpace | string | AgentSpace 名称。 | prod-agentspace |
| name | string | 评估器名称。 | trace\\_task\\_completion |
| displayName | string | 显示名称。 | 链路任务完成度 |
| metricName | string | 评估指标名称。 | agent\\_task\\_completion |
...
| currentVersion | string | 当前返回的版本号。 | 1.0.0 |
| config | object | 当前版本配置。 | {"prompt":"请评估任务完成度"} |
| properties | object | 评估器属性。 | {"agentEvaluatorMode":"raw\\_prompt"} |
| versions | array<object> | 版本列表。 | \\[{"version":"1.0.0"}\\] |
...
更多信息，参考[变更详情](https://api.aliyun.com/document/AgentLoop/2026-05-20/GetEvaluator#workbench-doc-change-demo)[变更详情](https://api.alibabacloud.com/document/AgentLoop/2026-05-20/GetEvaluator#workbench-doc-change-demo)。