---
source_url: "https://mp.weixin.qq.com/s?search_click_id=9985993073642493730-1784694805353-4187985418&__biz=Mzg2MDgzMDQzNA==&mid=2247493302&idx=1&sn=3ceaed5935e1812489dba05579268a3f&chksm=cf62785329fb4599bf2ed6db1d61620ae0ac19de8e05fe004f8ce5bef6b6e8d8d17078e09397&subscene=90&scene=7&clicktime=1784694805&enterid=1784694805&ascene=65&devicetype=iOS26.5.2&version=18004b43&nettype=3G+&abtest_cookie=AAACAA==&lang=zh_CN&countrycode=CN&fontScale=100&exportkey=n_&pass_ticket=JEApG5X8euckj4IjOOMDCW0hmUnidkp7VNtgnByVpTBS57zk1sfcaCLifg8eMsUt&wx_header=3"
title: "从 eBPF 到 LLM：可观测性管道的每一层都在变｜上海 Meetup 回顾"
account: "DeepFlow"
published_at: "2026-04-28T10:26:38.000Z"
saved_at: "2026-07-22T04:33:38.481Z"
sync_id: "art_8150d69e55ee42dd9859eb37c6030d98"
parse_status: "ok"
---
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_1.jpg)
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_2.jpg)

_向阳：谁来监管你的 AI Agent？_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_3.png)

_eBPF 内核层观测：智能体可以不写日志、不装 SDK、不经过 Gateway，但不能不经过内核发系统调用_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_4.jpg)

_万凯明：AutoMQ 基于共享存储架构的新一代 Diskless Kafka_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_5.png)

_AutoMQ 云原生 Kafka 架构：Shared Nothing 到 Shared Storage 的演进_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_6.jpg)

_庄晓丹：从 eBPF 到 LLM 的端到端 Demo_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_7.png)

_架构全景：DeepFlow + AutoMQ + GreptimeDB + MCP/LLM，持久化层全部跑在 S3 (MinIO) 上_演示跑在本机的一套完整 Kubernetes 集群上，20 个 Pod、5 个 Namespace。DeepFlow 通过 eBPF 抓取所有容器的网络流量，零埋点；数据经 AutoMQ 传输写入 GreptimeDB；Grafana 大盘实时展示。北极星指标：端到端延迟约 5 秒，错误率 0.24%，吞吐 200+ span/秒，累计采集超 140 万条 Span。
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_8.png)

_自然语言询问 GreptimeDB 运行情况_
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_9.jpg)
...
![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_10.png)

_GreptimeDB 在 OB Cloud 的日志存储架构：Fluent Bit 直采写入，多云统一接口_
...
添加 DeepFlow 社区小助，备注"上海 meetup"，可获取本次活动所有讲师 PPT。

![](附件资源/从%20eBPF%20到%20LLM：可观测性管道的每一层都在变｜上海%20Meetup%20回顾/img_11.png)

本次 DeepFlow 直播回放已在视频号发布，欢迎未能到场的朋友点击观看。
...
[《五年，全链路：一个城商行运维的成长之路》·前篇](https://mp.weixin.qq.com/s?__biz=Mzg2MDgzMDQzNA==&mid=2247493273&idx=1&sn=6cf538593d23a4de557392f2b714c806&scene=21#wechat_redirect)

[《五年，全链路：一个城商行运维的成长之路》·后篇](https://mp.weixin.qq.com/s?__biz=Mzg2MDgzMDQzNA==&mid=2247493288&idx=1&sn=8387d578d9c23342924914f20874409b&scene=21#wechat_redirect)

[DeepFlow 全栈可观测平台 赋能企业 OA 系统服务质量提升](https://mp.weixin.qq.com/s?__biz=Mzg2MDgzMDQzNA==&mid=2247493244&idx=1&sn=f899db7b92853d19c199539e0417714c&scene=21#wechat_redirect)
...
---
原文链接：https://mp.weixin.qq.com/s?__biz=Mzg2MDgzMDQzNA%3D%3D&mid=2247493302&idx=1&sn=3ceaed5935e1812489dba05579268a3f&chksm=cf62785329fb4599bf2ed6db1d61620ae0ac19de8e05fe004f8ce5bef6b6e8d8d17078e09397
